...
const char * projectName = "ESP8266 Garage Door Controller";
...
#define REL_PIN1       D2             // D1 = Relay 1 Output - Garage door
#define LED_PIN1       D4             // D4 = Built in LED
#define KEY_PIN1       D3             // D3 = Built in Flash Button - Hold for 20 seconds for partional flash clear.  Hold for 60 seconds for full flash clear
#define REL_PIN2       D1             // D2 = Relay 2 Output - Opener Light
#define DOORCLOSED_PIN D5             // D5 = Door Closed Sensor
...
#define DEFAULT_AUTO_OFF1              500
#define DEFAULT_AUTO_OFF2              500
#define DEFAULT_OPENINGDELAY           12200
#define DEFAULT_UREPORT                60
#define DEFAULT_DEBOUNCE               2000
...
void handleRoot() {
  server->send(200, "application/json", "{\"message\":\"Wifi Garage Controller\"}");
}
...
void relayToggle1() {
  ...
  server->send(200, "application/json", "{\"type\":\"relay\", \"number\":\"1\", \"power\":\"TURBO\"}");
  if (reading == LOW) {
    current_low1 = millis();
    state1 = LOW;
  }
...
boolean sendStatus(int number) {
  ...
  switch(number){
    ...
    case 3:{  // Magentic Switch 1 State Change
      switch(doorState){
        case Open: {
          message = "{\"type\":\"door\", \"state\":\"open\"}";
          break;
        }
        case Opening: {
          message = "{\"type\":\"door\", \"state\":\"opening\"}";
          break;
        }
        case Closed: {
          message = "{\"type\":\"door\", \"state\":\"closed\"}";
          break;
        }
        case Closing: {
          message = "{\"type\":\"door\", \"state\":\"closing\"}";
          break;
        }
        case Unknown: {
          message = "{\"type\":\"door\", \"state\":\"unknown\"}";
          break;
        }
       }     
      break;
...
void setup()
{
  ...
  // attachInterrupt(digitalPinToInterrupt(KEY_PIN1), extRelayToggle, CHANGE);
  
  pinMode(REL_PIN1, OUTPUT);
  pinMode(REL_PIN2, OUTPUT);

  pinMode(DOORCLOSED_PIN, INPUT_PULLUP);  // D5 = Door Closed Sensor
  attachInterrupt(digitalPinToInterrupt(DOORCLOSED_PIN), sensorChanged, CHANGE);
  d5State = digitalRead(DOORCLOSED_PIN);
  if(d5State == 0) doorState = Closed;
  else doorState = Open;
  ...
  if (SecuritySettings.settingsVersion < 205) {
    ...
    Settings.openingDelay = DEFAULT_OPENINGDELAY;
  ...
  String apSSID = "GarageDoor." + String(mac[4], HEX) + String(mac[5], HEX);

  if (!wifiManager.autoConnect(apSSID.c_str(), WIFI_HOTSPOT_PW.c_str())) {
  ...
  server->on("/advanced", []() {
    ...
    String openingDelay = server->arg("openingDelay");
    ...
    if(server->args() > 0){
      ...
      if (openingDelay.length() != 0)
      {
        Settings.openingDelay = openingDelay.toInt();
      }
      if (uReport.length() != 0)
      {
    ...
    reply += F("<TR><TD>How long your garage door takes to open:<TD><input type='text' name='openingDelay' value='");
    reply += Settings.openingDelay;
    reply += F("'>(ms)");
  ...
  server->on("/", []() {
    ...
    char str[20];
    addHeader(true, reply);
//    reply += F("<IMG src='data:image/png;base64,'/><BR>");
    reply += F("<IMG src='https://raw.githubusercontent.com/coolboarder/ESP8266GarageDoorController/master/images/garage.png'/><BR>");
    reply += F("<table>");
    reply += F("<TH colspan='2'>");
    reply += projectName;
    reply += F(" Main");
    ...
    reply += F("<a href='/open'>open</a><BR>");
    reply += F("<a href='/close'>close</a><BR>");
    reply += F("<a href='/light'>light</a><BR>");
  ...
  server->on("/configGet", []() {
    ...
    if (configName == "openingDelay") {
      reply += "{\"name\":\"openingDelay\", \"value\":\"" + String(Settings.openingDelay) + "\", \"success\":\"true\", \"type\":\"configuration\"}";
    }
  ...
  server->on("/configSet", []() {
    ...
    if (configName == "openingDelay") {
      if (configValue.length() != 0)
      {
        Settings.openingDelay = configValue.toInt();
      }
      reply += "{\"name\":\"openingDelay\", \"value\":\"" + String(Settings.openingDelay) + "\", \"success\":\"true\", \"type\":\"configuration\"}";
    }
  ...
  server->on("/open", []() {
    ...
    if(doorState == Closed || doorState == Unknown)
    {
      relayControl(1, 1);
      doorState = Opening;
      openingTimer = millis() + Settings.openingDelay;
      needUpdate3 = true;
      server->send(200, "application/json", "{\"type\":\"door\", \"state\":\"opening\"}");
    } else {
  ...
  server->on("/close", []() {
    ...
    if(doorState == Open || doorState == Unknown)
    {
      ...
      doorState = Closing;
      needUpdate3 = true;
      server->send(200, "application/json", "{\"type\":\"door\", \"state\":\"closing\"}");
    } else {
      server->send(200, "application/json", "");
    }
  });
  ...
  server->on("/off1", []() {
    ...
    server->send(200, "application/json", "{\"type\":\"contact\", \"state\":\"open\"}");
  });
  server->on("/off2", []() {
  ...
  server->on("/on1", []() {
    ...
    relayControl(1, 1);
    server->send(200, "application/json", "{\"type\":\"relay\", \"number\":\"1\", \"power\":\"" + String(Settings.currentState1? "on" : "off") + "\"}");
    server->send(200, "application/json", "{\"type\":\"contact\", \"state\":\"closed\"}");
  });
...
volatile boolean sensorDirty = false;
...
void handleSensor(){
  // Check Door Status
  // Door states: Closed, Opening, Open, Closing, Unknown
  // If D5 changes to low then send garage door closed
  // if D5 goes high -> low Door just closed
  // if D5 goes low -> high Door is opening
  
  DEBUG_MSG("SensorChanged D5 State is: %d\n",d5State);
   
   unsigned long interrupt_time = millis();
   static unsigned long last_interrupt_time = 0;
   // If interrupts come faster than 200ms, assume it's a bounce and ignore
   DEBUG_MSG("interrupt_time: %d last_interrupt_time: %d Debounce: %d\n",interrupt_time, last_interrupt_time, Settings.debounce);
  if (interrupt_time - last_interrupt_time > Settings.debounce)
  {
    DEBUG_MSG("Made it 1. Millis: %d openingTimer: %d d5State: %d \n",millis(), openingTimer, d5State);
    if(millis() > openingTimer) {
        needUpdate3 = true;
        DEBUG_MSG("Made it 2\n");
        if(d5State == 0){  // Door just closed
          DEBUG_MSG("Made it 3\n");
          doorState = Closed;
        }
        if(d5State == 1){  // Door is opening
          DEBUG_MSG("Made it 4\n");
          doorState = Opening;
          openingTimer = millis() + Settings.openingDelay;
      }
...
void loop()
{
  ...
  if (doorState == Opening && millis() > openingTimer)
  {
    if(digitalRead(DOORCLOSED_PIN) == 1)
      doorState = Open;
    else
      doorState = Closed;
    needUpdate3 = true;
  ...
  if (needUpdate1 == true || needUpdate2 == true) {
    //sendStatus(0);
  }
...
//    sendStatus(2);
  ...
  if ((Settings.autoOff1 != 0) && inAutoOff1 && ((millis() - autoOffTimer1) > (Settings.autoOff1))) {
    relayControl(1, 0);
    autoOffTimer1 = 0;
    inAutoOff1 = false;
  }
  if ((Settings.autoOff2 != 0) && inAutoOff2 && ((millis() - autoOffTimer2) > (Settings.autoOff2))) {
    relayControl(2, 0);
    autoOffTimer2 = 0;
    inAutoOff2 = false;
  }
